...
var stopsFile = fs.readFileSync("./stops2.txt","utf8");
var stopTimesFile = fs.readFileSync("./stop_timesPT1.txt","utf8");
var transfersFile = fs.readFileSync("./transfers.txt","utf8");
...
var seedTimes = function () {
    ...
    StopTimesModel.create(stopTimesList, function (err) {
        ...
        console.log('Stop Times PT1 seeded!');
        process.exit(0);
    });
};
